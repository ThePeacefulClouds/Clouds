...
public final class Newton1 {
    ...
    private static double sqrt(double x) {
        double r = x; /*
                       ...
                       * the guess
                       */
        final double epsilon = 0.0001; /* relative error of 0.01% */
         ...
         *
         *
         * r = (r+x/r)/2 to get a better estimation of square root because r is
         * the what the estimate is, x is what it should be. so (r+x/r) gives a
         * better estimate for r, for example 25+26/25 = 26.04, x is 26 so r
         * gets closer to x
         */
        return r;
